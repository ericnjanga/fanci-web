	...
	render(){
      ...
      <div className="mdl-card mdl-shadow--2dp"> 
        <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          ...
          <label className="mdl-textfield__label" for="input-name">User Name</label>
        </div>

        <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          <input className="mdl-textfield__input" type="text" id="input-email" />
          <label className="mdl-textfield__label" for="input-email">Email Address</label>
        </div>

        <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          <input className="mdl-textfield__input" type="text" id="input-phone" />
          <label className="mdl-textfield__label" for="input-phone">Phone Number</label>
        </div>

        <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          <textarea className="mdl-textfield__input" type="text" rows= "3" id="input-description"></textarea>
          <label className="mdl-textfield__label" for="input-description">Description</label>
        </div>
